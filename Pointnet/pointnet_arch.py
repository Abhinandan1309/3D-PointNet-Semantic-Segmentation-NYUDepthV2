...
class PointNetBackbone(nn.Module):
    ...
    ''' 
    def __init__(self, num_points=10000, num_global_feats=1024, local_feat=True):
        ''' Initializers:
...
class PointNetClassHead(nn.Module):
    '''' Classification Head '''
    def __init__(self, num_points=10000, num_global_feats=1024, k=2):
...
class PointNetSegHead(nn.Module):
    ''' Segmentation Head '''
    def __init__(self, num_points=10000, num_global_feats=1024, m=50):
